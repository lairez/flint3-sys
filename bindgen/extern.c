...
void _fmpz_poly_pseudo_divrem__extern(fmpz *Q, fmpz *R, ulong *d, const fmpz *A, slong A_len, const fmpz *B, slong B_len, const fmpz_preinvn_t inv) { _fmpz_poly_pseudo_divrem(Q, R, d, A, A_len, B, B_len, inv); }
...
int fq_nmod_is_primitive__extern(const fq_nmod_t op, const fq_nmod_ctx_t ctx) { return fq_nmod_is_primitive(op, ctx); }
...
int fq_zech_is_primitive__extern(const fq_zech_t op, const fq_zech_ctx_t ctx) { return fq_zech_is_primitive(op, ctx); }
...
int gr_get_fexpr__extern(fexpr_t res, gr_srcptr x, gr_ctx_t ctx) { return gr_get_fexpr(res, x, ctx); }
int gr_get_fexpr_serialize__extern(fexpr_t res, gr_srcptr x, gr_ctx_t ctx) { return gr_get_fexpr_serialize(res, x, ctx); }
int gr_set_fexpr__extern(gr_ptr res, fexpr_vec_t inputs, gr_vec_t outputs, const fexpr_t x, gr_ctx_t ctx) { return gr_set_fexpr(res, inputs, outputs, x, ctx); }
...
slong fq_mat_nrows__extern(const fq_mat_t mat, const fq_ctx_t UNUSED_ctx) { return fq_mat_nrows(mat, UNUSED_ctx); }
slong fq_mat_ncols__extern(const fq_mat_t mat, const fq_ctx_t UNUSED_ctx) { return fq_mat_ncols(mat, UNUSED_ctx); }
fq_struct * fq_mat_entry__extern(const fq_mat_t mat, slong i, slong j) { return fq_mat_entry(mat, i, j); }
int fq_mat_is_empty__extern(const fq_mat_t mat, const fq_ctx_t UNUSED_ctx) { return fq_mat_is_empty(mat, UNUSED_ctx); }
int fq_mat_is_square__extern(const fq_mat_t mat, const fq_ctx_t UNUSED_ctx) { return fq_mat_is_square(mat, UNUSED_ctx); }
void fq_mat_swap_rows__extern(fq_mat_t mat, slong *perm, slong r, slong s, const fq_ctx_t ctx) { fq_mat_swap_rows(mat, perm, r, s, ctx); }
void fq_mat_invert_rows__extern(fq_mat_t mat, slong *perm, const fq_ctx_t ctx) { fq_mat_invert_rows(mat, perm, ctx); }
slong fq_nmod_mat_nrows__extern(const fq_nmod_mat_t mat, const fq_nmod_ctx_t UNUSED_ctx) { return fq_nmod_mat_nrows(mat, UNUSED_ctx); }
slong fq_nmod_mat_ncols__extern(const fq_nmod_mat_t mat, const fq_nmod_ctx_t UNUSED_ctx) { return fq_nmod_mat_ncols(mat, UNUSED_ctx); }
fq_nmod_struct * fq_nmod_mat_entry__extern(const fq_nmod_mat_t mat, slong i, slong j) { return fq_nmod_mat_entry(mat, i, j); }
int fq_nmod_mat_is_empty__extern(const fq_nmod_mat_t mat, const fq_nmod_ctx_t UNUSED_ctx) { return fq_nmod_mat_is_empty(mat, UNUSED_ctx); }
int fq_nmod_mat_is_square__extern(const fq_nmod_mat_t mat, const fq_nmod_ctx_t UNUSED_ctx) { return fq_nmod_mat_is_square(mat, UNUSED_ctx); }
void fq_nmod_mat_swap_rows__extern(fq_nmod_mat_t mat, slong *perm, slong r, slong s, const fq_nmod_ctx_t ctx) { fq_nmod_mat_swap_rows(mat, perm, r, s, ctx); }
void fq_nmod_mat_invert_rows__extern(fq_nmod_mat_t mat, slong *perm, const fq_nmod_ctx_t ctx) { fq_nmod_mat_invert_rows(mat, perm, ctx); }
slong fq_zech_mat_nrows__extern(const fq_zech_mat_t mat, const fq_zech_ctx_t UNUSED_ctx) { return fq_zech_mat_nrows(mat, UNUSED_ctx); }
slong fq_zech_mat_ncols__extern(const fq_zech_mat_t mat, const fq_zech_ctx_t UNUSED_ctx) { return fq_zech_mat_ncols(mat, UNUSED_ctx); }
fq_zech_struct * fq_zech_mat_entry__extern(const fq_zech_mat_t mat, slong i, slong j) { return fq_zech_mat_entry(mat, i, j); }
int fq_zech_mat_is_empty__extern(const fq_zech_mat_t mat, const fq_zech_ctx_t UNUSED_ctx) { return fq_zech_mat_is_empty(mat, UNUSED_ctx); }
...
int fq_poly_is_zero__extern(const fq_poly_t poly, const fq_ctx_t UNUSED_ctx) { return fq_poly_is_zero(poly, UNUSED_ctx); }
void _fq_poly_inv_series__extern(fq_struct *Qinv, const fq_struct *Q, slong n, const fq_t cinv, const fq_ctx_t ctx) { _fq_poly_inv_series(Qinv, Q, n, cinv, ctx); }
void fq_poly_inv_series__extern(fq_poly_t Qinv, const fq_poly_t Q, slong n, const fq_ctx_t ctx) { fq_poly_inv_series(Qinv, Q, n, ctx); }
slong fq_nmod_poly_length__extern(const fq_nmod_poly_t poly, const fq_nmod_ctx_t UNUSED_ctx) { return fq_nmod_poly_length(poly, UNUSED_ctx); }
slong fq_nmod_poly_degree__extern(const fq_nmod_poly_t poly, const fq_nmod_ctx_t UNUSED_ctx) { return fq_nmod_poly_degree(poly, UNUSED_ctx); }
fq_nmod_struct * fq_nmod_poly_lead__extern(const fq_nmod_poly_t poly, const fq_nmod_ctx_t UNUSED_ctx) { return fq_nmod_poly_lead(poly, UNUSED_ctx); }
int fq_nmod_poly_is_zero__extern(const fq_nmod_poly_t poly, const fq_nmod_ctx_t UNUSED_ctx) { return fq_nmod_poly_is_zero(poly, UNUSED_ctx); }
void _fq_nmod_poly_inv_series__extern(fq_nmod_struct *Qinv, const fq_nmod_struct *Q, slong n, const fq_nmod_t cinv, const fq_nmod_ctx_t ctx) { _fq_nmod_poly_inv_series(Qinv, Q, n, cinv, ctx); }
void fq_nmod_poly_inv_series__extern(fq_nmod_poly_t Qinv, const fq_nmod_poly_t Q, slong n, const fq_nmod_ctx_t ctx) { fq_nmod_poly_inv_series(Qinv, Q, n, ctx); }
slong fq_zech_poly_length__extern(const fq_zech_poly_t poly, const fq_zech_ctx_t UNUSED_ctx) { return fq_zech_poly_length(poly, UNUSED_ctx); }
slong fq_zech_poly_degree__extern(const fq_zech_poly_t poly, const fq_zech_ctx_t UNUSED_ctx) { return fq_zech_poly_degree(poly, UNUSED_ctx); }
fq_zech_struct * fq_zech_poly_lead__extern(const fq_zech_poly_t poly, const fq_zech_ctx_t UNUSED_ctx) { return fq_zech_poly_lead(poly, UNUSED_ctx); }
int fq_zech_poly_is_zero__extern(const fq_zech_poly_t poly, const fq_zech_ctx_t UNUSED_ctx) { return fq_zech_poly_is_zero(poly, UNUSED_ctx); }
void _fq_zech_poly_inv_series__extern(fq_zech_struct *Qinv, const fq_zech_struct *Q, slong n, const fq_zech_t cinv, const fq_zech_ctx_t ctx) { _fq_zech_poly_inv_series(Qinv, Q, n, cinv, ctx); }
void fq_zech_poly_inv_series__extern(fq_zech_poly_t Qinv, const fq_zech_poly_t Q, slong n, const fq_zech_ctx_t ctx) { fq_zech_poly_inv_series(Qinv, Q, n, ctx); }
...
slong fq_zech_mpoly_ctx_nvars__extern(const fq_zech_mpoly_ctx_t ctx) { return fq_zech_mpoly_ctx_nvars(ctx); }
ordering_t fq_zech_mpoly_ctx_ord__extern(const fq_zech_mpoly_ctx_t ctx) { return fq_zech_mpoly_ctx_ord(ctx); }
void _fq_zech_mpoly_set_length__extern(fq_zech_mpoly_t A, slong newlen, const fq_zech_mpoly_ctx_t UNUSED_ctx) { _fq_zech_mpoly_set_length(A, newlen, UNUSED_ctx); }
void fq_zech_mpoly_truncate__extern(fq_zech_mpoly_t A, slong newlen, const fq_zech_mpoly_ctx_t UNUSED_ctx) { fq_zech_mpoly_truncate(A, newlen, UNUSED_ctx); }
void fq_zech_mpoly_swap__extern(fq_zech_mpoly_t A, fq_zech_mpoly_t B, const fq_zech_mpoly_ctx_t UNUSED_ctx) { fq_zech_mpoly_swap(A, B, UNUSED_ctx); }
...
int fq_zech_mpoly_is_zero__extern(const fq_zech_mpoly_t A, const fq_zech_mpoly_ctx_t UNUSED_ctx) { return fq_zech_mpoly_is_zero(A, UNUSED_ctx); }
fq_zech_struct * fq_zech_mpoly_leadcoeff__extern(const fq_zech_mpoly_t A, const fq_zech_mpoly_ctx_t UNUSED_ctx) { return fq_zech_mpoly_leadcoeff(A, UNUSED_ctx); }
slong fq_zech_mpoly_length__extern(const fq_zech_mpoly_t A, const fq_zech_mpoly_ctx_t UNUSED_ctx) { return fq_zech_mpoly_length(A, UNUSED_ctx); }
void fq_zech_mpoly_univar_swap__extern(fq_zech_mpoly_univar_t A, fq_zech_mpoly_univar_t B, const fq_zech_mpoly_ctx_t UNUSED_ctx) { fq_zech_mpoly_univar_swap(A, B, UNUSED_ctx); }
slong fq_zech_mpoly_univar_length__extern(const fq_zech_mpoly_univar_t A, const fq_zech_mpoly_ctx_t UNUSED_ctx) { return fq_zech_mpoly_univar_length(A, UNUSED_ctx); }
void fq_zech_mpoly_univar_get_term_coeff__extern(fq_zech_mpoly_t c, const fq_zech_mpoly_univar_t A, slong i, const fq_zech_mpoly_ctx_t ctx) { fq_zech_mpoly_univar_get_term_coeff(c, A, i, ctx); }
void fq_zech_mpoly_univar_swap_term_coeff__extern(fq_zech_mpoly_t c, fq_zech_mpoly_univar_t A, slong i, const fq_zech_mpoly_ctx_t ctx) { fq_zech_mpoly_univar_swap_term_coeff(c, A, i, ctx); }
void fq_zech_bpoly_init__extern(fq_zech_bpoly_t A, const fq_zech_ctx_t UNUSED_ctx) { fq_zech_bpoly_init(A, UNUSED_ctx); }
void fq_zech_bpoly_swap__extern(fq_zech_bpoly_t A, fq_zech_bpoly_t B, const fq_zech_ctx_t UNUSED_ctx) { fq_zech_bpoly_swap(A, B, UNUSED_ctx); }
void fq_zech_bpoly_fit_length__extern(fq_zech_bpoly_t A, slong len, const fq_zech_ctx_t ctx) { fq_zech_bpoly_fit_length(A, len, ctx); }
void fq_zech_bpoly_zero__extern(fq_zech_bpoly_t A, const fq_zech_ctx_t UNUSED_ctx) { fq_zech_bpoly_zero(A, UNUSED_ctx); }
int fq_zech_bpoly_is_zero__extern(const fq_zech_bpoly_t A, const fq_zech_ctx_t UNUSED_ctx) { return fq_zech_bpoly_is_zero(A, UNUSED_ctx); }
slong fq_zech_bpoly_degree0__extern(const fq_zech_bpoly_t A, const fq_zech_ctx_t UNUSED_ctx) { return fq_zech_bpoly_degree0(A, UNUSED_ctx); }
void fq_zech_tpoly_init__extern(fq_zech_tpoly_t A, const fq_zech_ctx_t UNUSED_ctx) { fq_zech_tpoly_init(A, UNUSED_ctx); }
void fq_zech_tpoly_swap__extern(fq_zech_tpoly_t A, fq_zech_tpoly_t B, const fq_zech_ctx_t UNUSED_ctx) { fq_zech_tpoly_swap(A, B, UNUSED_ctx); }
void fq_zech_polyu_init__extern(fq_zech_polyu_t A, const fq_zech_ctx_t UNUSED_ctx) { fq_zech_polyu_init(A, UNUSED_ctx); }
void fq_zech_polyu_fit_length__extern(fq_zech_polyu_t A, slong len, const fq_zech_ctx_t ctx) { fq_zech_polyu_fit_length(A, len, ctx); }
void fq_zech_polyu_swap__extern(fq_zech_polyu_t A, fq_zech_polyu_t B, const fq_zech_ctx_t UNUSED_ctx) { fq_zech_polyu_swap(A, B, UNUSED_ctx); }
void fq_zech_polyun_init__extern(fq_zech_polyun_t A, const fq_zech_ctx_t UNUSED_ctx) { fq_zech_polyun_init(A, UNUSED_ctx); }
void fq_zech_polyun_fit_length__extern(fq_zech_polyun_t A, slong len, const fq_zech_ctx_t ctx) { fq_zech_polyun_fit_length(A, len, ctx); }
void fq_zech_polyun_swap__extern(fq_zech_polyun_t A, fq_zech_polyun_t B, const fq_zech_ctx_t UNUSED_ctx) { fq_zech_polyun_swap(A, B, UNUSED_ctx); }
void fq_zech_mpoly_factor_swap__extern(fq_zech_mpoly_factor_t A, fq_zech_mpoly_factor_t B, const fq_zech_mpoly_ctx_t UNUSED_ctx) { fq_zech_mpoly_factor_swap(A, B, UNUSED_ctx); }
